...
<head>
   ...
   <link rel="stylesheet" href="/movie-ticket-booking/public/assets/css/showtime.css">
...
<div class="booking-container">
    ...
    <!-- DATE SELECTION -->
    <div class="card"><h2>Chọn Ngày Chiếu</h2>
        <div class="date-list">
    ...
    <div class="action-group">
        ...
        <form action="/movie-ticket-booking/public/test.php" method="GET" style="margin: 0;">
            <input type="hidden" name="page" value="seat">
            <input type="hidden" name="movie_id" value="<?php echo $movie_id; ?>">
            <input type="hidden" name="showtime_id" id="showtime_id_input" value="2">
            <button type="submit" class="btn-next">Tiếp Tục Chọn Ghế →</button>
        </form>
    </div>
</div>
<script>
